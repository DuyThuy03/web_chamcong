...
const Layout = ({ children }) => {
  ...
  const handleLogout = async () => {
    ...
    React.useEffect(() => {
        ...
        const handleLeaveCancelled = () => {
             console.log("Leave cancelled notification received");
             setLeaveUnreadCount(prev => Math.max(0, prev - 1));
        };
        ...
        wsService.on("LEAVE_CANCELED", handleLeaveCancelled);
        ...
        return () => {
            ...
            wsService.off("LEAVE_CANCELED", handleLeaveCancelled);
        };
  ...
  return (
    <div className="h-screen flex flex-col bg-[var(--bg-primary)] transition-colors duration-300 overflow-hidden">
      {/* Header - Fixed Height */}
      <header className="bg-[var(--bg-secondary)] border-b border-[var(--border-color)] z-40 shrink-0 transition-colors duration-300">
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center gap-6">
              ...
              <button
                ...
                className="flex items-center gap-2 text-red-500 hover:text-red-600 transition-all hover:scale-110 active:scale-95"
              >
                <LogOut size={20} />
      ...
      {/* Body - Flex Row to take remaining height */}
      <div className="flex flex-1 overflow-hidden">
              ...
              return (
                <Link
                  ...
                  className={`
                    ...
                    hover:scale-110 active:scale-90 hover:shadow-md
                    ${
                      isActive
                        ? "bg-[var(--bg-primary)] text-[var(--accent-color)] border-[var(--accent-color)] shadow-[0_0_15px_rgba(0,0,0,0.1)]"
                        : "text-[var(--text-secondary)] border-transparent hover:bg-[var(--bg-primary)] hover:text-[var(--text-primary)] hover:border-[var(--accent-color)]"
                    }
                  `}
                >
                  <Icon size={20} />
        ...
        <main className="flex-1 p-6 overflow-y-auto bg-[var(--bg-primary)] text-[var(--text-primary)] transition-colors duration-300 scroll-smooth">
