...
const CheckOutForm = ({ onSuccess, checkInData }) => {
  ...
  return (
    <div className="bg-[var(--bg-secondary)] rounded-lg shadow-sm border border-[var(--border-color)] overflow-hidden font-sans transition-all duration-300 hover:shadow-lg hover:border-rose-300">
      ...
      <div className="p-4 md:p-8">
        ...
        <div className="mb-8 p-6 bg-[var(--bg-secondary)] rounded-lg shadow-sm relative overflow-hidden group border border-[var(--border-color)] transition-all duration-300 hover:shadow-md hover:border-[var(--accent-color)] hover:-translate-y-0.5">
            ...
            <div className="w-full lg:w-5/12 shrink-0">
               ...
               <div 
                  className={`
                    ...
                    ${photoPreview ? 'border-rose-500 shadow-lg shadow-rose-500/20 ring-4 ring-rose-500/10' : 'border-dashed border-[var(--border-color)] bg-[var(--bg-primary)] hover:bg-[var(--bg-secondary)] hover:border-rose-400 cursor-pointer hover:shadow-md hover:scale-[1.02]'}
                  `}
                  onClick={() => {
                    if (!photoPreview) {
                      setShowCamera(true);
                   ...
                   <button
                     ...
                     className={`
                       ...
                       ${loading || !photo || !location 
                         ...
                         : 'bg-rose-600 hover:shadow-rose-500/40 hover:-translate-y-1 hover:scale-[1.02] active:scale-[0.85]'
                       }
                     `}
                   >
                     {loading ? (
