...
const AttendancePage = () => {
  ...
  return (
    <div className="min-h-[100dvh] bg-[var(--bg-primary)] px-4 pt-[calc(1rem_+_env(safe-area-inset-top))] pb-[calc(1rem_+_env(safe-area-inset-bottom))] font-sans transition-colors duration-200">
            ...
            <div className="bg-[var(--bg-secondary)] rounded-lg shadow-sm border border-[var(--border-color)] overflow-hidden text-left transition-colors duration-300">
               ...
               <div className="p-3 bg-[var(--bg-primary)] border-t border-[var(--border-color)]">
                   <Link 
                     ...
                     className="block w-full py-2.5 bg-[var(--accent-color)] text-white font-bold rounded-md text-center transition-all hover:brightness-110 text-sm shadow-sm hover:shadow-lg hover:scale-105 active:scale-[0.85]"
                     style={{ color: "#000" }}
                   >
                     Về trang chủ
                   </Link>
