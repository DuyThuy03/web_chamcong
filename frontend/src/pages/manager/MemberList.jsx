...
const MemberListPage = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    if (!formData.department_id) newErrors.push("Vui lòng chọn phòng ban.");
    if (!formData.role) newErrors.push("Vui lòng chọn vai trò.");
      ...
      <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] shadow-sm p-4 rounded-lg transition-colors duration-300">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2 ml-10 md:ml-0">
            ...
            <button
              onClick={() => openForm()}
              className="flex items-center gap-2 bg-[var(--accent-color)] hover:brightness-110 text-black px-3 py-2 shadow-sm font-medium transition-all text-sm rounded-md hover:shadow-lg hover:scale-105 hover:-translate-y-1 active:scale-95 active:translate-y-0 active:shadow-none"
            >
              <UserPlus size={16} />
              Thêm thành viên
            </button>
          ...
          {loading && members.length === 0 ? (
            ...
            <>
                        ...
                        <td className="px-4 py-3 text-right">
                          <div className="flex justify-end gap-2">
                            <button
                              ...
                              className="p-2 bg-blue-500/10 text-blue-500 hover:bg-blue-500 hover:text-white transition-all rounded-lg shadow-sm hover:shadow-lg hover:scale-110 hover:-translate-y-1 active:scale-[0.85] active:translate-y-0 active:shadow-none"
                              title="Xem chi tiết"
                            >
                              <Eye size={16} />
                            </button>
                            <button
                              onClick={() => openForm(m)}
                              className="p-2 bg-amber-500/10 text-amber-500 hover:bg-amber-500 hover:text-white transition-all rounded-lg shadow-sm hover:shadow-lg hover:scale-110 hover:-translate-y-1 active:scale-[0.85] active:translate-y-0 active:shadow-none"
                              title="Chỉnh sửa"
                            >
                              <Edit size={16} />
                            </button>
                            <button
                              ...
                              className="p-2 bg-rose-500/10 text-rose-500 hover:bg-rose-500 hover:text-white transition-all disabled:opacity-30 disabled:cursor-not-allowed rounded-lg shadow-sm hover:shadow-lg hover:scale-110 hover:-translate-y-1 active:scale-[0.85] active:translate-y-0 active:shadow-none"
                              title="Xóa"
              ...
              <div className="lg:hidden space-y-3">
                {members.map((m) => (
                  <div key={m.id} className="p-4 space-y-3 bg-[var(--bg-secondary)] rounded-lg shadow-sm border border-[var(--border-color)] active:scale-[0.99] transition-all">
                    <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center justify-between pt-2">
                      ...
                      <div className="flex gap-2">
                        <button
                          onClick={() => handleViewDetail(m)}
                          className="p-3 border border-blue-500/20 text-blue-500 hover:bg-blue-500 hover:text-white transition-all rounded-lg active:scale-[0.85]"
                        >
                          <Eye size={24} />
                        </button>
                        <button
                          onClick={() => openForm(m)}
                          className="p-3 border border-amber-500/20 text-amber-500 hover:bg-amber-500 hover:text-white transition-all rounded-lg active:scale-[0.85]"
                        >
                          <Edit size={24} />
                        </button>
                        <button
                          onClick={() => handleDelete(m.id)}
                          className="p-3 border border-rose-500/20 text-rose-500 hover:bg-rose-500 hover:text-white transition-all disabled:opacity-30 rounded-lg active:scale-[0.85]"
                          disabled={m.role === "Trưởng phòng"}
                        >
                          <Trash2 size={24} />
                        </button>
            ...
            <form onSubmit={handleFormSubmit} noValidate>
              ...
              <div className="p-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="sm:col-span-1">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center px-2 pointer-events-none mr-1">
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2 bg-[var(--bg-primary)] border border-[var(--border-color)] text-[var(--text-primary)] rounded-lg focus:ring-2 focus:ring-[var(--accent-color)] outline-none resize-none transition-all placeholder-gray-500 text-sm"
                  />
                </div>
              </div>
              ...
              <div className="bg-[var(--bg-primary)] px-6 py-4 flex flex-col sm:flex-row justify-end gap-3 sticky bottom-0 z-10 border-t border-[var(--border-color)]">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="px-6 py-2.5 bg-[var(--accent-color)] text-white/90 rounded-xl hover:brightness-110 font-medium shadow-sm disabled:opacity-50 flex items-center justify-center gap-2 transition-all hover:scale-110 hover:-translate-y-1 hover:shadow-lg active:scale-95 active:translate-y-0 active:shadow-none"
                  style={{ color: '#000' }}
                >
                  {loading && (
