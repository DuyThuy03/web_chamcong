              ...
              <table className="w-full text-sm text-left">
                <thead className="bg-[var(--bg-primary)] text-white [.light_&]:text-gray-700 font-semibold border-b-2 border-slate-600 [.light_&]:border-slate-200 uppercase text-xs tracking-wider sticky top-0 z-10">
                  <tr>
                    ...
                    <th className="px-4 py-4 text-center border-r border-slate-600 [.light_&]:border-slate-200">Ngày làm</th>
                    <th className="px-4 py-4 text-center border-r border-slate-600 [.light_&]:border-slate-200">Nghỉ phép</th>
