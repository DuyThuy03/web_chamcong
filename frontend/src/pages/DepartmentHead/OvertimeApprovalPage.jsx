            ...
            <>
              ...
              <div className="hidden lg:block overflow-x-auto">
                <table className="min-w-full text-left border-collapse">
                  ...
                  <tbody className="">
                    {requests.map((r) => {
                      // Init rate if undefined, using 1.0 default for pending, or r.adjusted_rate for processed if exists
                      // Be careful: r.adjusted_rate might be from DB for processed ones. 
                      // For pending, we use state or 1.0
